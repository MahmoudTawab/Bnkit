...
class PosVC: UIViewController , UITextFieldDelegate ,FPNTextFieldDelegate {
    ...
    let StackVertical = UIStackView(arrangedSubviews: [EmailTF,FullNameTF,MobileTF,ProductInterestedTF,LengthOfBusinessTF,CommentsTF])
    ...
    StackVertical.frame = CGRect(x: ControlX(20), y: ControlY(110), width: view.frame.width - ControlX(40), height: ControlHeight(340))

//    ViewScroll.addSubview(CheckboxButton)
//    ViewScroll.addSubview(UserAgreementLabel)
    ViewScroll.addSubview(SubmitButton)
        
//    CheckboxButton.frame = CGRect(x: ControlX(15), y: ControlY(520), width: ControlHeight(35), height: ControlHeight(35))
//
//    UserAgreementLabel.frame = CGRect(x: ControlX(55), y: ControlY(530), width: ControlHeight(300), height: ControlHeight(20))

    SubmitButton.frame = CGRect(x: view.center.x - ControlWidth(60), y: ControlY(520), width: ControlWidth(120), height: ControlHeight(40))
    ...
    lazy var  ProductInterestedTF : UITextField = {
        let tf = FloatingTF()
        tf.attributedPlaceholder = NSAttributedString(string: "ProductInterestedIn".localizable, attributes:[.foregroundColor: LabelForeground])
        return tf
    }()
...
extension PosVC {
    ...
    guard let ProductInterested = ProductInterestedTF.text else {return}
...
//    return
    ...
    let parameters: [String: Any] = [
        ...
        "uid": uid,
        "sysToken": sysToken,
        "projectSectorTypId": 4,
        "email": email,
        "fullName": FullName,
        "mobile": PhoneNew,
        "proInterestedIn": ProductInterested,
