//
//  AcquisitionApplicantVC.swift
//  AcquisitionApplicantVC
//
...
class AcquisitionApplicantVC: UIViewController , UITextFieldDelegate {
    ...
    lazy var TopBackView: TopView = {
        ...
        View.text = "ACQUISITIONAPPLICANT".localizable
...
extension AcquisitionApplicantVC : UIDocumentPickerDelegate {
...
///----------------------------------------------
extension AcquisitionApplicantVC {
    ...
    let api = "\(url + PhoneAcquisitionRequest)"
